...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 01-03-2022 a las 00:42:06
...
CREATE TABLE IF NOT EXISTS `activated_sections` (
...
CREATE TABLE IF NOT EXISTS `articles` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `title_article` (`title`),
  UNIQUE KEY `url_article` (`url`)
...
CREATE TABLE IF NOT EXISTS `dont_show` (
  `id` int(3) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `users` (`id`, `complete_name`, `username`, `email`, `phone`, `verified`, `password`, `role`, `registered_date`, `failed_attempts_made`, `last_login`, `logged_now`, `last_failed_attempt`, `last_block`, `keep_open_session`, `deleted`, `deleted_at`) VALUES
(5, 'Fernando Carrillo', 'fernando', 'fernando@mail.com', '0996549881', 0, '$2y$10$WjLBGOHYqZzPo2GqNgBLTea5cekR83k0kbv1sVtIH05QHztD3tf4K', 1, '2022-02-13 09:52:33', 0, '2022-02-13 09:53:57', NULL, NULL, NULL, 0, 0, NULL),
(6, 'Andre', 'andre', 'andre@mail.com', '0996549881', 0, '', 3, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, NULL, NULL, 0, 0, NULL);
COMMIT;
