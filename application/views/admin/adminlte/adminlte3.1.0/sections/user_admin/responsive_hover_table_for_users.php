    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <a href="<?php echo base_url('') ?>" class="btn btn-primary"><i class="fas fa-user-plus"></i> Add a New User</a>
                ...
                <table class="table table-hover text-nowrap">
                    ...
                    <tbody id="table_body">
                        ...
                        foreach ($sections_admin['content'] as $user) {
                            ...
                            echo "<td><a href=\"" . base_url("admin/users_admin/update_user/") . $user['id'] . "\"\n>";
                            echo "<i class=\"fas fa-user-edit\"></i> Edit\n";
                            echo "</a></td>\n";
                            echo "<td><a href=\"" . base_url("admin/users_admin/delete_user/") . $user['id'] . "\"\n>";
